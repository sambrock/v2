...
export const projectSlideAnimateIn = scroll => {
  ...
  tl.fromTo('.project-slide.active .project-slide__mask', .6, { webkitClipPath: polygonIn[scroll], clipPath: polygonIn[scroll], ease: "Power2.easeInOut" }, { webkitClipPath: polygonIn.end, clipPath: polygonIn.end, ease: "Power2.easeInOut" })
...
export const projectSlideAnimateOut = scroll => {
  ...
  tl.fromTo('.project-slide.active .project-slide__mask', .6, { webkitClipPath: polygonOut.start, clipPath: polygonOut.start, ease: "Power2.easeInOut" }, { webkitClipPath: polygonOut[scroll], clipPath: polygonOut[scroll], ease: "Power2.easeInOut" })
...
export const projectPageAnimateIn = (height) => {
  ...
  tl.fromTo('.project__mainimg', .6, { opacity: 1, y: height * 0.5, ease: "Power2.easeInOut" }, { y: 0, ease: "Power2.easeInOut" }, 0)
    ...
    .fromTo('.project__logo', .1, { opacity: 0, ease: "Power2.easeInOut" }, { opacity: 1, ease: "Power2.easeInOut" }, 0.2, 0)
...
export const maskAnimate = () => {
  ...
  tl.fromTo('.page__mask', 1, { webkitClipPath: polygonIn.down, clipPath: polygonIn.down, ease: "Power3.easeInOut" }, { webkitClipPath: polygonIn.end, clipPath: polygonIn.end, ease: "Power3.easeInOut" }, 0)
    .fromTo('.page__mask', 1, { webkitClipPath: polygonIn.end, clipPath: polygonIn.end, ease: "Power3.easeInOut" }, { webkitClipPath: polygonIn.up, clipPath: polygonIn.up, ease: "Power3.easeInOut" })
...
export const maskAnimateHome = () => {
  ...
  tl.fromTo('.page__mask', 1.2, { display: 'block', webkitClipPath: polygonIn.down, clipPath: polygonIn.down, ease: "Power2.easeInOut" }, { webkitClipPath: polygonIn.end, clipPath: polygonIn.end, ease: "Power2.easeInOut" }, 0)
...
export const indexAnimateIn = () => {
  ...
  tl.fromTo('.intro__name .txt-mask', .5, { webkitClipPath: 'inset(0 0 0 0)', clipPath: 'inset(0 0 0 0)', ease: "Power1.easeInOut" }, { webkitClipPath: 'inset(0 0 0 100%)', clipPath: 'inset(0 0 0 100%)', ease: "Power1.easeInOut" })
    .fromTo('.intro__description .txt-mask', .5, { webkitClipPath: 'inset(0 0 0 0)', clipPath: 'inset(0 0 0 0)', ease: "Power1.easeInOut" }, { webkitClipPath: 'inset(0 0 0 100%)', clipPath: 'inset(0 0 0 100%)', ease: "Power1.easeInOut" }, .2)
    .fromTo('.intro__btn .txt-mask', .5, { webkitClipPath: 'inset(0 0 0 0)', clipPath: 'inset(0 0 0 0)', ease: "Power1.easeInOut" }, { webkitClipPath: 'inset(0 0 0 100%)', clipPath: 'inset(0 0 0 100%)', ease: "Power1.easeInOut" }, .6)
    .fromTo('.project-slide.active .project-slide__mask', .6, { webkitClipPath: polygonIn.down, clipPath: polygonIn.down, ease: "Power2.easeInOut" }, { webkitClipPath: polygonIn.end, clipPath: polygonIn.end, ease: "Power2.easeInOut" }, .3)
    ...
    .fromTo('footer', .2, { opacity: 0, ease: "Power2.easeInOut" }, { opacity: 1, ease: "Power2.easeInOut" })
...
export const projectHeroScroll = () => {
  const tl = new gsap.timeline();

  tl.to('.project__mainimg img', .5, { y: -window.pageYOffset / 5 }, 0);
